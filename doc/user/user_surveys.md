...
After using Sourcegraph for a few days, users are presented with a request to answer "How likely is it that you would recommend NBShare to a friend?", and to provide some qualitative product feedback.
